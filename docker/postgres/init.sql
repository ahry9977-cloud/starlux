...
CREATE TABLE IF NOT EXISTS notificationSettings (
  ...
  emailWallet BOOLEAN NOT NULL DEFAULT TRUE,
  emailStore BOOLEAN NOT NULL DEFAULT TRUE,
  emailSubscription BOOLEAN NOT NULL DEFAULT TRUE,
  emailSystem BOOLEAN NOT NULL DEFAULT TRUE,
  emailCommunication BOOLEAN NOT NULL DEFAULT TRUE,
...
CREATE UNIQUE INDEX IF NOT EXISTS userDeviceTokens_user_token_unique ON userDeviceTokens(userId, token);
